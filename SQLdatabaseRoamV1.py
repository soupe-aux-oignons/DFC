...
def IDinsertion(table,face_path,results):#assume insertRow works
    ...
    print("mycursor is this :",mycursor)
    ...
    for img_path in img_paths :
        ...
        for result_dic in results :
            ...
            if  sizeAreaRatioCheck(img_save,face,importance) :
                ...
                print(IDinsertion(faceTable,f"{output_path}/face.{i}.jpg",result_list))
                i+=1
...
if __name__=="__main__":
  ...
  print(comparateurDeepface(load(analysis_path)[0],load(output_path)[0]))
